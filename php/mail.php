<?php
	...
	$address = "_sir_@MAIL.RU";//адрес куда будет отсылаться сообщение для администратора
	...
	if ($send) //проверяем, отправилось ли сообщение
		echo "Сообщение отправлено успешно! Перейти на <a href='http://zamermwg.beget.tech/'>zamermwg.beget.tech</a>, если вас не перенаправило вручную.";
	else 
